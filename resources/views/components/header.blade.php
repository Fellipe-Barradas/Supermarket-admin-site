...
<nav class="bg-[#222831] border-gray-200 text-white flex-none">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
        ...
        <button data-collapse-toggle="navbar-default" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm rounded-lg md:hidden focus:outline-none hover:ring-2 focus:ring-gray-200" aria-controls="navbar-default" aria-expanded="false">
