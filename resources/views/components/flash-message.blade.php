@if( session('success') )
    <div x-data="{ open: true }" x-show="open" class="flex justify-between items-center p-4 mt-3 mb-3 text-sm text-green-800 rounded-lg bg-green-50" role="alert">
...
@elseif( session('error') )
    <div x-data="{ open: true }" x-show="open" class="flex justify-around items-center p-4 mb-4 mt-3 text-sm text-red-800 rounded-lg bg-red-50" role="alert">
