<x-layout title="Clientes overview">
    <main class="max-w-screen-xl p-2 mt-3 mx-auto">
        ...
        <p class="mt-4 text-2xl">Clientes cadastrados no sitemas</p>
        <p class="mt-2 font-thin">Lista de clientes</p>
        <x-table :data="$customers" action="customers"></x-table>
    </main>
</x-layout>
